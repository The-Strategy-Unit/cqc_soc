...
The rate of change in HONOS scores was calculated as the HONOS score at the end of the spell divided by the HONOS score at the start of the spell such that rates of change less than 1 indicate improvement in MH symptoms. Most spells had  reduction in HONOS scores (@fig-honos-histo) with `r tar_read(honos_perc_worse) |> dplyr::pull(perc_worse) |> janitor::round_half_up(2)`% showing a worsening in symptoms.
