...
- Most lengths of Mental Health Act detention spells are up to 1 day long.
...
- Median length of stay is lower for patients in White ethnic categories compared to all other groups.
...
- Almost half of MHA detentions had a redetention within 12 months. This varies by ICB.
...
- The percentage of MHA detentions with a MHA redetention within 12 months is higher for compared to all other groups.
...
- The percentage of MHA detentions that had a subsequent MH admission within 12 months has increased to `r readmissions_23_24`% in 2022/23.
...
- For the `r perc_last_assess`% of CYP MH spells that had a full HONOS assessment within 7 days of the start and another within 7 days of the end of the spell, `r honos_perc_worse`% had an increase in HONOS scores from the start to the end of the spell.
...
tar_read(conversion_map) |> 
  filter(fin_year != '2018-2019', fin_year != '2024-2025', age_group != '25+', epi_count > 1) |>
...
The following analysis quantifies the scale of certain subset of conversions within detention spells. The list of conversions was specified by the CQC team. In these plots, the percentage of detention spells containing at least one instance of the specific sequence of conversions is shown. These are not exclusive categories since a spell can have multiple conversions. For example, a spell like "5(2)-3-3" will be counted in the "Section 5(2) to Section 3" and "Section 3 renewal".
...
```{r}
#| label: fig-conversion-map-3
#| fig-cap: Percentage of pathways containing at least one section 3 renewal by ICB.
tar_read(mha_conv_map_3)
```

###### Section 136 to Section 2

```{r}
#| label: fig-conversion-map-136-2
#| fig-cap: Percentage of pathways containing at least one section 3 renewal by ICB.
tar_read(mha_conv_map_136_2)
```

###### Section 5(2) to Section 2

```{r}
#| label: fig-conversion-map-52-2
#| fig-cap: Percentage of pathways containing at least one section 3 renewal by ICB.
tar_read(mha_conv_map_52_2)
```
:::
...
The percentage of MHA re-detentions is greater for females compared to males and higher for 18-24 years olds compared to under 18s. The percentage of MHA re-detentions is greater for patients from areas with the lowest IMD decile compared to all other IMD deciles. These patterns are the inverse of the patterns found for MHA detention spell length of stay (@sec-los). If certain groups of patients have shorter lengths of stay but are more likely to have a re-detention, then this may suggest that these groups are being discharged too early or without sufficient care arrangements. **?????? Please help me phrase this fairly????????**
...
Data was not readily available on assessments of clinical outcomes. Health of Nation Outcome Scales (HONOS) and the Health of Nation Outcome Scales for Children and Adolescents (HONOSCA) were used since they were the most complete, however there were still low completion rates. Due to the low numbers of full assessments, breakdowns are not provided and the term HONOS is used to mean both HONOS and HONOSCA combined.

Of the `r number_spells` CYP MH spells that ended between 1st April 2018 and 31st March 2023, `r perc_honos_assess`% had at least 1 full HONOS assessment (@fig-honos-flow). `r perc_last_assess`% of CYP MH spells had a full HONOS assessment within 7 days of the start and another within 7 days of the end of the spell. Of the `r number_spells` CYP MH spells since 1st April 2018, `r perc_honos_assess`% had at least 1 full HONOS assessment (@fig-honos-flow) and `r perc_last_assess`% of CYP MH spells had a full HONOS assessment within 7 days of the start and another within 7 days of the end of the spell.
...
## Admissions and distance from home

The Ward Location Distance from Home variable represents the geographical distance between a patient's residential address and the ward location where they received treatment. This metric is commonly used to assess the accessibility of healthcare services and inform population health planning. By understanding the distance between a patient's home and the healthcare facility, we can gain insights into the convenience and proximity of services, identify potential barriers to healthcare access, and inform resource allocation decisions.

The data and analysis in this section relates to **all** mental health inpatient admissions and not just those associated with detention under the MHA.
...
**Interpretation:** Lower values may indicate greater accessibility and convenience for patients. Higher values may suggest potential barriers to healthcare access, such as long travel times or transportation difficulties or may reflect centralisation of service provision.

The distance to travel (DTT) for each admission was calculated as the average distance per admission and the median distance per admission. The analysis includes breakdowns by fiscal year, ICB, gender, age group, and ethnicity allowing us to observe distance-related trends. The DTT is also compared with the total number of admissions in order to understand whether increasing or decreasing demand may be a contributing factor to changes in DTT.
...
While the gender descrepancy has improved over time, there remains a consistent difference between males and females in average DTT over the time period. In 2017/18 females traveled on average 29.1% farther than males and by 2024/25 they still travelled 18.7% farther than males on average. The median DTT for females and males saw the same trend as the median DTT for females was 25.0% farther than for males in 2017/18 and 18.2% farther in 2024/25.
...
##### General observations on ethnicity trends

-   White Group: Admissions dropped substantially from 13,341 in 2017/18 to 10,427 in 2023/24, while average travel distances increased modestly. The median DTT increased from 11 to 12 over this period.

-   Black Group: The number of admissions decreased from 958 in 2017/18 to 391 in 2024/25. Both average and median travel distances increased during this period, with a 3% rise in Avg. DTT and a 16.7% increase in Median DTT.

-   Asian Group: Despite the significant drop in admissions (from 823 in 2017/18 to 343 in 2024/25), average travel distances remained stable, with a slight decrease in median travel distance.

-   Mixed Group: While admissions decreased by 67%, from 686 to 227 over the years, both average and median travel distances increased. Avg. DTT rose from 26.91 to 27.84, and Median DTT increased from 8 to 9.

-   Other Group: The Other group saw the most dramatic rise in travel distances despite the sharp drop in admissions. Avg. DTT increased by 64%, while Median DTT saw an 83% increase over this period.
...
The least deprived group (IMD 10) consistently travels much further on average compared to the most deprived group. The difference between the most and least deprived groups in 2017/18 was 9.75 units (IMD 10 at 29.09 vs IMD 1 at 19.33), and by 2023/24, the difference remained significant at 6.43 units (IMD 10 at 30.88 vs IMD 1 at 24.45). The least deprived group (IMD 10) consistently travels much further on average compared to the most deprived group. The difference between the most and least deprived groups in 2017/18 was 9.75 km (IMD 10 at 29.09 vs IMD 1 at 19.33), and by 2023/24, the difference remained significant at 6.43 km (IMD 10 at 30.88 vs IMD 1 at 24.45).
...
The median DTT is often lower than the average DTT, suggesting that most patients travel shorter distances, while a few travel very long distances, skewing the average.
...
##### **General Spread of Values Across ICBs**:

**Urban vs. Rural Divide**: There is a clear divide between urban and rural ICBs, with rural areas requiring substantially longer travel distances for healthcare access. For example, NHS Cornwall and the Isles of Scilly, NHS Lincolnshire, and NHS Somerset show consistently higher DTT values. Urban ICBs, such as NHS London-based ICBs, have shorter travel distances, with average DTT values often under 20 km.
...
![](Heather%20Scratch%20Space/Tableau%20Plots/MM%20FY.png)
:::
...
![](Heather%20Scratch%20Space/Tableau%20Plots/Gender%20MM%20FY.png)
:::
...
![](Heather%20Scratch%20Space/Tableau%20Plots/Age%20MM%20FY.png)
:::
...
![](Heather%20Scratch%20Space/Tableau%20Plots/Ethnicity%20MM%20FY.png)
:::
...
##### Mean vs Median Deciles

![](Heather%20Scratch%20Space/Tableau%20Plots/IMD%20MM%20FY%20corrected.png)

##### Mean vs Median Quintiles

![](Heather%20Scratch%20Space/Tableau%20Plots/IMD%20MM%20FY%20corrected%20quintile.png)
:::
...
![](Heather%20Scratch%20Space/Tableau%20Plots/ICB%20MM%20FY.png)
:::
:::::::::

#### Average DTT alongside number of admissions
...
![](Heather%20Scratch%20Space/Tableau%20Plots/IMD%20by%20age%20gender%20time%20corrected%20avg.png)

##### IMD: Mean and median trends over time by gender

![](Heather%20Scratch%20Space/Tableau%20Plots/IMD%20quintile%20gender%20corrected.png)
...
#| fig-cap: "Map summarizing average travel distance by ICB (Most Deprived) in 2023-2024."
...
#| fig-cap: "Map summarizing average travel distance by ICB (Least Deprived) in 2023-2024."
...
#| fig-cap: "Map summarizing average travel distance by ICB (IMD 1) 2023-2024."
...
#| fig-cap: "Map summarizing average travel distance by ICB (IMD 2) 2023-2024."
...
#| fig-cap: "Map summarizing average travel distance by ICB (IMD 3) 2023-2024."
...
#| fig-cap: "Map summarizing average travel distance by ICB (IMD 4) 2023-2024."
...
#| fig-cap: "Map summarizing average travel distance by ICB (IMD 5) 2023-2024."
...
#| fig-cap: "Map summarizing average travel distance by ICB (IMD 6) 2023-2024."
...
#| fig-cap: "Map summarizing average travel distance by ICB (IMD 7) 2023-2024."
...
#| fig-cap: "Map summarizing average travel distance by ICB (IMD 8) 2023-2024."
...
#| fig-cap: "Map summarizing average travel distance by ICB (IMD 9) 2023-2024."
...
#| fig-cap: "Map summarizing average travel distance by ICB (IMD 10) 2023-2024."
