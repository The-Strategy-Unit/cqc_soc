...
The relative change in HONOS scores was calculated as the HONOS score at the end of the spell divided by the HONOS score at the start of the spell minus 1. Most spells had a reduction in HONOS scores (@fig-honos-histo), with `r tar_read(honos_perc_worse) |> dplyr::pull(perc_worse) |> janitor::round_half_up(2)`% showing a worsening in symptoms.
