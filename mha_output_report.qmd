...
number_detentions <- tar_read(conversion_map) |> 
  filter(fin_year != '2018-2019', 
         fin_year != '2024-2025', 
         age_group != '25+') |> 
  summarise(spells = sum(spells)) |> 
  pull(spells)

number_single_episode_detentions <- tar_read(conversion_map) |>
  filter(fin_year != '2018-2019', 
         fin_year != '2024-2025', 
         age_group != '25+', 
         epi_count == 1) |> 
...
number_multi_episode_detentions <- tar_read(conversion_map) |>
  filter(fin_year != '2018-2019', 
         fin_year != '2024-2025', 
         age_group != '25+', 
         epi_count > 1) |> 
...
- **INSERT SOMETHING HERE ABOUT SPECIFIC PATHWAYS BY GROUP**
...
This is all MHA detention spells in 2023/24 containing a conversion from Section 2 to Section 3. This includes detentions starting with under any section of the MHA and spells with any number or pattern of sections, including renewals of sections. 
