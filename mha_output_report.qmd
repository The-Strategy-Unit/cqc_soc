...
tar_read(mha_conv_from_4_map) +
  ggplot2::labs(caption = "Grey areas for ICBs that had no spells starting with Section 4 converted to Sections 2 or 3 .")
```
...
tar_read(mha_conv_from_136_map)
```
...
tar_read(mha_conv_from_54_map) +
  ggplot2::labs(caption = "Grey areas for ICBs that had no spells starting with Section 5(4) converted to Sections 2, 3 or 5(2).")
```
...
![](images/clipboard-1492561400.png)
:::
...
![](images/clipboard-1940657192.png)
:::
...
##### Mean vs Median![](images/clipboard-1348949205.png)
:::
...
Note: Each dot represents one ICB ![](Heather%20Scratch%20Space/Tableau%20Plots/ICB%20MM%20FY.png)
:::
...
:::::: panel-tabset
#### Gender and Age Group over time (FY)
...
#### IMD trends by Gender Over Time

![](images/clipboard-3644674288.png)
