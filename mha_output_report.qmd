...
```{r}
llos_perc <- tar_read(cyp_los) |>
  dplyr::mutate("llos" = ifelse(los > 365, 1, 0)) |>
...
![](Heather Scratch Space/Tableau Plots/Chart DTT Admissions FY Gender Age.png)

![](Heather Scratch Space/Tableau Plots/Table of Subgroups FY 202021 - 202425.png)

#### ![](Heather Scratch Space/Tableau Plots/Trends Overview FY.png)

![](Heather Scratch Space/Tableau Plots/Good example.png)

```{r}
library(magick)
img <- image_read("Heather Scratch Space/Tableau Plots/Good example.png")
plot(img)
