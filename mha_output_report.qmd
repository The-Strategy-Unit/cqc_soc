...
When considering the total distance traveled by each subgroup over time, as shown in Figure @fig:Proportion_Total_DTT_Gender_Age, the split further emphasizes the disproportionate distance traveled by females, particularly in the younger age cohort (0–17). Over time, females have consistently accounted for a larger proportion of the total DTT for this age group. For example, in 2017/18, females in the 0–17 group made up 64% of the total distance traveled by that cohort, and this share has remained relatively high, with fluctuations between 62% and 66% through 2024/25. This is despite the fact that, as proportion of all admissions, females aged 0-17 contribute the least to total admissions, though the gender gap is much more narrow - see Figure @fig:Proportion_Admissions_Gender_Age_Gap.
...
![](Heather Scratch Space/Tableau Plots/Final fig for report age gender proportions avg DTT.png){#fig:Percent_Gender_Age_DTT_Table}
