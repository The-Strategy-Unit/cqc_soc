...
In general, whilst things have improved over time, there are persistent data quality issues with the MHSDS in terms of coverage, completion and consistency of data available for secondary analysis. Additionally, the cyber incident from 2020 still impacts on the submissions from a number of providers across the country. Submissions from independent sector providers are also thought to be affected more by data completion and data quality issues.
