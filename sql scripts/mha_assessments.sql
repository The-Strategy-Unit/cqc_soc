...
, min(pseudo_StartDateMHActLegalStatusClass) as spell_start_date
...
----## isolating assessments during MHA spells
...
----## summary of codes used during MHA spells
