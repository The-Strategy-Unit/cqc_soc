...
list(
  ...
  tar_target(mha_conv_from_52,
             get_conversions_from_section(conversion_map_cyp, "5(2)")),
  tar_target(mha_conv_from_54,
             get_conversions_from_section(conversion_map_cyp, "5(4)")),
  tar_target(mha_conv_from_4,
             get_conversions_from_section(conversion_map_cyp, "4")),
  tar_target(mha_conv_from_136,
             get_conversions_from_section(conversion_map_cyp, "136")),

  tar_target(mha_conv_from_52_map,
             get_conversions_from_map(conversion_map_cyp,
                                      "5(2)",
                                      icb_boundary,
                                      icb_codes_names)),
